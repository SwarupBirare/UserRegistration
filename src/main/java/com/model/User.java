...
public class User {
    ...
    public User(int id, String name, String email, String password, String phone, String address, int age) {
        this.id = id;
        this.name = name;
        this.email = email;
	...
	@Override
	public int hashCode() {
		return Objects.hash(address, age, email, id, name, password, phone);
	}
